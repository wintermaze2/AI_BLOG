...
-- =====================================================================
--
-- 2026-08-28: '문자 보안' 추가. 문자(SMS) 발송 비중이 이메일과 비슷해져
--   문자 관련 주제를 별도 축으로 분리한다.
-- 2026-09-18: '문자 작성팁' 추가. 문자 글이 늘면서 보안과 발송 실무를 나눈다.
--   같은 날 '문자보안' -> '문자 보안' 으로 고쳤다. 운영 DB 에는 공백이 있는
--   이름으로 들어가 있는데 이 파일만 공백이 없어, 재실행하면
--   ON DUPLICATE KEY UPDATE 가 DB 의 이름을 덮어쓰는 상태였다.
-- =====================================================================
